...
export class MyproductComponent implements OnInit {
  ...
  constructor(private fakestoreService: FakestoreService, private activeRoute: ActivatedRoute, private usersService: UsersService,
              private productService: ProductService, private dummyApi: DummyApiService, private sasionsService: SeasionsService) {
  }
  ...
  addToCart() {
    this.productService.CheckExistingCart(this.sasionsService.getCurrentUser(), this.product.id).then(results => {
      if (results) {
